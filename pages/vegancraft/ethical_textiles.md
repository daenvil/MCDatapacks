...
abstract: "Plant-based alternatives for string, leather, beds, feathers, and armadillo scute. Use together with <i>Acacia Gum</i> to have fully vegan leather."
priority: 4
index: 12
gallery: [images/vegancraft/ethical_textiles/thumbnail.png]
---
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="26-2">
        <p>
            ...
            <br/>
            {% include dp_download.html version="v2.2.3" pmc-url="https://www.planetminecraft.com/data-pack/ethical-textiles-plant-string-and-leather/" github-url="https://github.com/daenvil/vegancraft/releases/download/v1.7/ethical_textiles_v2.2.3.zip" rp-version="v2.2.3" rp-github-url="https://github.com/daenvil/vegancraft/releases/download/v1.7/vegancraft-RP_v1.7.zip" %}
        </p>
    </div>
    <div role="tabpanel" class="tab-pane" id="1-21-9">
        <p>
            ...
            <br/>
            {% include dp_download.html version="v2.2.1" github-url="https://github.com/daenvil/vegancraft/releases/download/v1.5.1/ethical_textiles_v2.2.1.zip" rp-version="v1.5.1" rp-github-url="https://github.com/daenvil/vegancraft/releases/download/v1.5.1/vegancraft-RP_v1.5.1.zip" %}
        </p>
    </div>
    <div role="tabpanel" class="tab-pane" id="1-21-5">
        <p>
            ...
            <br/>
            {% include dp_download.html version="v2.2" github-url="https://github.com/daenvil/vegancraft/releases/download/v1.4.2/ethical_textiles_v2.2.zip" rp-version="v1.4" rp-github-url="https://github.com/daenvil/vegancraft/releases/download/v1.4/vegancraft-RP_v1.4.zip" %}
        </p>
    </div>
    <div role="tabpanel" class="tab-pane" id="legacy">
        ...
        <table><thead>
            ...
            <tr>
                ...
                <td>2.1</td>
                <td>1.21.4</td>
                <td>Github: <a href='https://github.com/daenvil/vegancraft/releases/download/v1.3/ethical_textiles_v2.1.zip'>datapack</a> | <a href='https://github.com/daenvil/vegancraft/releases/download/v1.3/vegancraft-RP_v1.3.zip'>resourcepack</a></td>
            </tr>
            <tr>
                <td>1.21.2–1.21.3</td>
                <td>2.0.3</td>
                <td>1.21.3</td>
                <td>Github: <a href='https://github.com/daenvil/vegancraft/releases/download/v1.2.2/ethical_textiles_v2.0.3.zip'>datapack</a> | <a href='https://github.com/daenvil/vegancraft/releases/download/v1.2.2/vegancraft-RP_v1.2.2.zip'>resourcepack</a></td>
            </tr>
            <tr>
                <td>1.21–1.21.1</td>
                <td>2.0.2</td>
                <td>1.21.1</td>
                <td>Github: <a href='https://github.com/daenvil/vegancraft/releases/download/v1.2.1/ethical_textiles_v2.0.2.zip'>datapack</a> | <a href='https://github.com/daenvil/vegancraft/releases/download/v1.2/vegancraft-RP_v1.2.zip'>resourcepack</a></td>
            </tr>
            <tr>
                <td>1.20.5–1.20.6</td>
                <td>2.0</td>
...
{% include image/basic.html src="vegancraft/ethical_textiles/screenshots/recipes/string.gif" alt="Plant string recipes" align="center" width="300" %}

#### Faux feathers
Craft faux **feathers** with a stick, two strings, and one of any leaves.

{% include image/basic.html src="vegancraft/ethical_textiles/screenshots/recipes/feather.png" alt="Faux Feather recipe" align="center" width="300" %}

#### Synthetic cobwebs
**Cobwebs** can be crafted a slime ball surrounded by 8 strings.

{% include image/basic.html src="vegancraft/ethical_textiles/screenshots/recipes/cobweb.png" alt="Synthetic Cobweb recipe" align="center" width="300" %}

#### Armor scales
Crafted with a diamond, two strings, and a slime ball. It's an alternative to **armadillo scute**. Use it to craft wolf armor without using armadillos.

{% include image/basic.html src="vegancraft/ethical_textiles/screenshots/recipes/armor_scale.png" alt="Armor Scale recipe" align="center" width="300" %}
{% include image/basic.html src="vegancraft/ethical_textiles/screenshots/recipes/wolf_armor.png" alt="Wolf armor recipe using armor scales instead of armadillo scutes" align="center" width="300" %}

#### Alternative brush recipe
With this datapack, you can craft a regular brush using **4 string instead of a feather**.

{% include image/basic.html src="vegancraft/ethical_textiles/screenshots/recipes/brush.png" alt="Armor Scale recipe" align="center" width="300" %}

#### Alternative item frame recipe
You can also craft a regular item frame using **paper of leather**.
