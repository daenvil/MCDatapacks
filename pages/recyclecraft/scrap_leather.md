...
published: true
modrinth: https://modrinth.com/datapack/scrap-leather
...
priority: 5
index: 3
downloads: 870 # 870 in pmc before migrating to modrinth
downloads_str: "&gt;800"
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="26-3">
        <p>
            ...
            <br/>
            {% include dp_download.html version="v2.2.2" modrinth-url="https://cdn.modrinth.com/data/4mMF7O2U/versions/d7e4KlKy/scrap_leather_v2.2.2.zip?mr_download_reason=standalone" dropbox-url="https://www.dropbox.com/scl/fi/e1izutc2jvga5qg160iks/scrap_leather_v2.2.2.zip?rlkey=7vieu1of77y5sx7cqpilhkqyo&st=jadl1htr&dl=1" %}
        </p>
    </div>
    <div role="tabpanel" class="tab-pane" id="1-21-9">
        <p>
            ...
            <br/>
            {% include dp_download.html version="v2.2.1" dropbox-url="https://www.dropbox.com/scl/fi/z48hztvuv459ybnjb8hfg/scrap_leather_v2.2.1.zip?rlkey=gy1a1ia71i6i5kidsxkplgxgj&st=cy4pssqz&dl=1" discontinued=true %}
        </p>
    </div>
    <div role="tabpanel" class="tab-pane" id="1-21-5">
        <p>
            ...
            <br/>
            {% include dp_download.html version="v2.2" dropbox-url="https://www.dropbox.com/scl/fi/y34bnick0jqnz892x2r21/scrap_leather_v2.2.zip?rlkey=9043iokyxte0ikxsaq1u2giw4&st=nu8djprf&dl=1" discontinued=true %}
        </p>
    </div>
    <div role="tabpanel" class="tab-pane" id="legacy">
        ...
        <table><thead>
            ...
            <tr>
                ...
                <td>2.1.2</td>
                <td>1.21.3</td>
                <td><a href='https://www.dropbox.com/scl/fi/hj55kdanqu06ay7cfn8h9/scrap_leather_v2.1.2.zip?rlkey=cxf9hi1pgg9jenmxudjyvi0pf&st=hk9kkvzg&dl=1'>Dropbox</a></td>
            </tr>
            <tr>
                <td>1.21–1.21.1</td>
                <td>2.1.1</td>
                <td>1.21</td>
                <td><a href='https://www.dropbox.com/scl/fi/p27x3q7gonojf9hkiip96/scrap_leather_v2.1.1.zip?rlkey=5cytrn2nbnytq0wm6d7k9pjjp&st=bqwlx3f0&dl=1'>Dropbox</a></td>
            </tr>
            <tr>
                <td>1.20.5–1.20.6</td>
                <td>2.1</td>
...
- Leather **chestplates**, **leggings**, **horse armor**, and **ghast harness** ⇒ 2 pieces of leather each.
...
- The leather ⇒ rabbit hides recipe is kind of useless in vanilla since rabbit hide is not used for anything, but it makes sense that you can just tear apart a piece of leather in smaller pieces and it may help for recipes from other mods or future updates.
