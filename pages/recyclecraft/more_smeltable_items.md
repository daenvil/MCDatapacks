...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="current">
        <p>
            {% include dp_badges.html supports="1.19%2B" tested="1.17.1%2C%201.18.2%2C%201.19" %}
            <br/>
            {% include dp_download.html version="v2.0.4" mirror-url="http://adfoc.us/76840385198908" mirror-platform="AdFocus" %}
        </p>
    </div>
...
{% include collapsible.html id='to-copper-ingots' title='Items smeltable to copper ingots' content='<ul><li>Lightning rod</li><li>Spyglass</li><li>Any cut copper slab or stairs</li></ul>' %}
