...
<div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="1-21-9">
        <p>
            ...
            <br/>
            {% include dp_download.html version="v1.1.4" dropbox-url="https://www.dropbox.com/scl/fi/95cgic63755cvldkqrpqa/recyclable_glass_v1.1.4.zip?rlkey=kq44ijl2zjb34kcbid6yu3i5k&st=bbj9nq11&dl=1" discontinued=true %}
        </p>
    </div>
    ...
    <div role="tabpanel" class="tab-pane" id="legacy">
        ...
        <table><thead>
            ...
            <tr>
                ...
                <td>1.1.2</td>
                <td>1.21.3</td>
                <td><a href='https://www.dropbox.com/scl/fi/bvzlwr2q6t78g734zouwg/recyclable_glass_v1.1.2.zip?rlkey=4azbb5w6o9es2lxu4taox4u5q&st=8w5r4tp3&dl=1'>Dropbox</a></td>
            </tr>
            <tr>
                <td>1.21–1.21.1</td>
                <td>1.1.1</td>
                <td>1.21</td>
                <td><a href='https://www.dropbox.com/scl/fi/2o79ey4wpmcc2qxhvv1dk/recyclable_glass_v1.1.1.zip?rlkey=0zvaukfcsw0g3ytdkm1qca6i5&st=ill7u2et&dl=1'>Dropbox</a></td>
            </tr>
            <tr>
                <td>1.20.5–1.20.6</td>
                <td>1.1</td>
...
{% include image/basic.html align='center' src='recyclecraft/recyclable_glass/diagram.png' width='480' caption='Diagram showing the new recipes as green arrows, along with the vanilla ones in red.' %}
